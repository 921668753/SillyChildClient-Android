...
public class ClassificationDetailsPresenter implements ClassificationDetailsContract.Presenter {
    private ClassificationDetailsContract.View mView;

    public ClassificationDetailsPresenter(ClassificationDetailsContract.View view) {
        mView = view;
