 ...
 * 包车详情----接机
 */
public class ChatRowPickupInformation extends ChatRow {

    private TextView tv_flightNumber1;
    private TextView tv_pickUpAtAirport1;
    ...
    public ChatRowPickupInformation(Context context, Message message, int position, BaseAdapter adapter) {
        super(context, message, position, adapter);
    }

    @Override
    protected void onInflatView() {
        inflater.inflate(message.direct() == Message.Direct.RECEIVE ? R.layout.item_message_customerservice1 : R.layout.item_message_pickupinformation, this);
    }
    ...
    private void initView() {
        ...
        tv_pickUpAtAirport1 = (TextView) findViewById(R.id.tv_pickUpAtAirport1);
        ...
        tv_seating1 = (TextView) findViewById(R.id.tv_seating1);
    ...
    protected void onSetUpView() {
        ...
        try {
            ...
            tv_pickUpAtAirport1.setText(message.getStringAttribute("airport_name"));
            tv_deliveredSite1.setText(message.getStringAttribute("start_address"));
