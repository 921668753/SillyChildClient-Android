...
import com.yinglan.scc.message.interactivemessage.rongcloud.SealConst;
import com.yinglan.scc.message.interactivemessage.rongcloud.broadcast.BroadcastManager;
...
import com.yinglan.scc.message.interactivemessage.rongcloud.moudle.SealExtensionModule;
...
import com.yinglan.scc.message.interactivemessage.rongcloud.response.ContactNotificationMessageData;
...
//                context.startActivity(new Intent(context, NewFriendListActivity.class));
    ...
    public boolean onReceived(Message message, int i) {
        ...
        if (messageContent instanceof ContactNotificationMessage) {
            ...
            Log.e("", "onReceived:" + groupNotificationMessage.getMessage());
