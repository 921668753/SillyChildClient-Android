package com.yinglan.scc.message.interactivemessage.rongcloud.util;
...
import com.yinglan.scc.message.interactivemessage.rongcloud.db.BlackListDao;
import com.yinglan.scc.message.interactivemessage.rongcloud.db.DBManager;
import com.yinglan.scc.message.interactivemessage.rongcloud.db.Friend;
import com.yinglan.scc.message.interactivemessage.rongcloud.db.FriendDao;
import com.yinglan.scc.message.interactivemessage.rongcloud.db.GroupMember;
import com.yinglan.scc.message.interactivemessage.rongcloud.db.GroupMemberDao;
import com.yinglan.scc.message.interactivemessage.rongcloud.db.Groups;
import com.yinglan.scc.message.interactivemessage.rongcloud.db.GroupsDao;
import com.yinglan.scc.message.interactivemessage.rongcloud.db.UserInfoBean;
import com.yinglan.scc.message.interactivemessage.rongcloud.model.GroupInfoEngine;
import com.yinglan.scc.message.interactivemessage.rongcloud.network.async.AsyncTaskManager;
import com.yinglan.scc.message.interactivemessage.rongcloud.network.async.OnDataListener;
import com.yinglan.scc.message.interactivemessage.rongcloud.network.http.HttpException;
import com.yinglan.scc.message.interactivemessage.rongcloud.pingyin.CharacterParser;
import com.yinglan.scc.message.interactivemessage.rongcloud.response.GetBlackListResponse;
import com.yinglan.scc.message.interactivemessage.rongcloud.response.GetGroupInfoResponse;
import com.yinglan.scc.message.interactivemessage.rongcloud.response.GetGroupMemberResponse;
import com.yinglan.scc.message.interactivemessage.rongcloud.response.GetGroupResponse;
import com.yinglan.scc.message.interactivemessage.rongcloud.response.GetTokenResponse;
import com.yinglan.scc.message.interactivemessage.rongcloud.response.UserRelationshipResponse;
...
//                            }
    ...
    public void setUserInfoEngineListener() {
        ...
        GroupInfoEngine.getInstance(mContext).setmListener(new GroupInfoEngine.GroupInfoListeners() {
            ...
            public void onResult(Group info) {
                if (info != null && RongIM.getInstance() != null) {
                    Log.d(TAG, "SealUserInfoManager getGroupInfo from network " + info.getId() + " " + info.getName() + " " + info.getPortraitUri());
                    if (TextUtils.isEmpty(info.getPortraitUri() == null ? null : info.getPortraitUri().toString())) {
    ...
    private boolean fetchGroups() throws HttpException {
        ...
        try {
            ...
            Log.d(TAG, "fetchGroups occurs JSONException e=" + e.toString());
            return true;
        }
        ...
        mWorkHandler.post(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    e.printStackTrace();
                    mGetAllUserInfoState &= ~GROUPS;
                    Log.d(TAG, "fetchGroups occurs HttpException e=" + e.toString() + "groupID=" + groupID);
                } catch (JSONException e) {
                    e.printStackTrace();
                    Log.d(TAG, "fetchGroups occurs JSONException e=" + e.toString() + "groupID=" + groupID);
                }
                sp.edit().putInt("getAllUserInfoState", mGetAllUserInfoState).commit();
            }
        });
    ...
    private List<Groups> pullGroups() throws HttpException {
        ...
        try {
            ...
            Log.d(TAG, "pullGroups occurs JSONException e=" + e.toString());
            return null;
        }
        if (groupResponse != null && groupResponse.getCode() == 200) {
    ...
    private Groups pullGroups(String groupID) throws HttpException {
        ...
        try {
            ...
            Log.d(TAG, "pullGroups(String groupID) occurs JSONException e=" + e.toString());
            return null;
        }
        if (groupResponse != null && groupResponse.getCode() == 200) {
            List<GetGroupResponse.ResultEntity> list = groupResponse.getResult();
        ...
        if (mGroupsList != null && mGroupsList.size() > 0) {
            ...
            for (Groups group : mGroupsList) {
                ...
                try {
                    ...
                    Log.d(TAG, "fetchGroupMembers occurs JSONException e=" + e.toString() + ", groupID=" + group.getGroupsId());
                    fetchGroupCount++;
                    continue;
                }
            ...
            public void run() {
                ...
                if (hasGetAllGroupMembers()) {
                    ...
                    try {
                        ...
                        setGetAllUserInfoWithPartGroupMembersState();
                        sp.edit().putInt("getAllUserInfoState", mGetAllUserInfoState).commit();
                        Log.d(TAG, "getGroupMember occurs HttpException e=" + e.toString() + "groupID=" + groupID);
                        return;
                    } catch (JSONException e) {
                        e.printStackTrace();
                        Log.d(TAG, "getGroupMember occurs JSONException e=" + e.toString() + "groupID=" + groupID);
                        return;
                    }
                    if (groupMemberResponse != null && groupMemberResponse.getCode() == 200) {
                        List<GetGroupMemberResponse.ResultEntity> list = groupMemberResponse.getResult();
        ...
        if (mGroupsList != null && mGroupsList.size() > 0) {
            ...
            for (Groups group : mGroupsList) {
                ...
                try {
                    ...
                    Log.d(TAG, "pullGroupMembers(String groupsID) occurs JSONException e=" + e.toString() + ", groupID=" + groupsID);
                    fetchGroupCount++;
                    continue;
                }
                if (groupMemberResponse != null && groupMemberResponse.getCode() == 200) {
    ...
    private boolean fetchBlackList() throws HttpException {
        ...
        try {
            ...
            Log.d(TAG, "fetchBlackList occurs JSONException e=" + e.toString());
            return true;
        }
    ...
    private List<BlackList> pullBlackList() throws HttpException {
        ...
        try {
            ...
            Log.d(TAG, "pullBlackList occurs JSONException e=" + e.toString());
            return null;
        }
        if (blackListResponse != null && blackListResponse.getCode() == 200) {
            ...
            public void run() {
                ...
                if (!doingGetAllUserInfo && !hasGetGroups()) {
                    ...
                    try {
                        ...
                        onCallBackFail(callback);
                        Log.d(TAG, "getGroups occurs HttpException e=" + e.toString() + "mGetAllUserInfoState=" + mGetAllUserInfoState);
                        return;
                    }
                } else {
                ...
                public void run() {
                    ...
                    if (!doingGetAllUserInfo && (!hasGetAllGroupMembers() || hasGetPartGroupMembers())) {
                        ...
                        try {
                            ...
                            onCallBackFail(callback);
                            Log.d(TAG, "getGroupMembers occurs HttpException e=" + e.toString() + "mGetAllUserInfoState=" + mGetAllUserInfoState);
                            return;
                        }
                    } else {
            ...
            public void run() {
                ...
                if (!doingGetAllUserInfo && !hasGetBlackList()) {
                    ...
                    try {
                        ...
                        onCallBackFail(callback);
                        Log.d(TAG, "getBlackList occurs HttpException e=" + e.toString() + "mGetAllUserInfoState=" + mGetAllUserInfoState);
                        return;
                    }
                } else {
                    ...
                    if (!doingGetAllUserInfo && !hasGetGroups()) {
                        if (isNetworkConnected()) {
                            try {
                                ...
                                onCallBackFail(callback);
                                Log.d(TAG, "getGroupsByID occurs HttpException e=" + e.toString() + "mGetAllUserInfoState=" + mGetAllUserInfoState);
                                return;
                            }
                        } else {
                            onCallBackFail(callback);
        ...
        if (result != null) {
            if (requestCode == GET_TOKEN) {
                ...
                if (tokenResponse.getCode() == 200) {
                    final String token = tokenResponse.getResult().getToken();
