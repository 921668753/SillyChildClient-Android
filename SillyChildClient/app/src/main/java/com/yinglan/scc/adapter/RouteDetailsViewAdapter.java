...
import com.yinglan.scc.entity.LocalTalentBean.ResultBean.ListBean;
...
public class RouteDetailsViewAdapter extends BGAAdapterViewAdapter<ListBean> {

    public RouteDetailsViewAdapter(Context context) {
        super(context, R.layout.item_routedetails);
    }
