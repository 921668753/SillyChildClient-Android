...
import com.yinglan.scc.adapter.MasonryAdapter;
import com.yinglan.scc.constant.NumericConstants;
import com.yinglan.scc.custominterfaces.FragmentJumpBetween;
...
public class FansCollectionDynamicFragment extends BaseFragment implements FansAttentionContract.View,MasonryAdapter.MasonryItemOnClickListener,PullLoadMoreRecyclerView.PullLoadMoreListener{
    ...
    public void getSuccess(String success, int flag) {
        switch (flag){
            ...
            case 3:
                ...
                ((FansAttentionPresenter)mPresenter).getOtherInfo(aty.getFansuserid(),"3",pagenum);
                break;
            default:
