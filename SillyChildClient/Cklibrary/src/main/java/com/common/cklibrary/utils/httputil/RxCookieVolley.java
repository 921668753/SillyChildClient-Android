 ...
 * Cookie持久化封装
 */
public class RxCookieVolley {
    private RxCookieVolley() {
    }

    public final static File CACHE_FOLDER = FileUtils.getExternalCacheDir("RxCookieVolley");
    ...
    public static class Builder {
         ...
         * Http请求参数
         */
        public RxCookieVolley.Builder params(HttpParams params) {
            this.params = params;
            return this;
        }
         ...
         */
        public RxCookieVolley.Builder contentType(int contentType) {
         ...
         * 请求回调,不需要可以为空
         */
        public RxCookieVolley.Builder callback(HttpCallback callback) {
         ...
         * HttpRequest
         */
        public RxCookieVolley.Builder setRequest(Request<?> request) {
         ...
         */
        public RxCookieVolley.Builder setTag(Object tag) {
         ...
         * HttpRequest的配置器
         */
        public RxCookieVolley.Builder httpConfig(RequestConfig httpConfig) {
         ...
         */
        public RxCookieVolley.Builder timeout(int timeout) {
         ...
         */
        public RxCookieVolley.Builder progressListener(ProgressListener listener) {
         ...
         */
        public RxCookieVolley.Builder delayTime(int delayTime) {
         ...
         * 缓存有效时间,单位分钟
         */
        public RxCookieVolley.Builder cacheTime(int cacheTime) {
         ...
         */
        public RxCookieVolley.Builder useServerControl(boolean useServerControl) {
         ...
         */
        public RxCookieVolley.Builder httpMethod(int httpMethod) {
            this.httpConfig.mMethod = httpMethod;
            if (httpMethod == RxCookieVolley.Method.POST) {
         ...
         * 是否启用缓存
         */
        public RxCookieVolley.Builder shouldCache(boolean shouldCache) {
         ...
         * 网络请求接口url
         */
        public RxCookieVolley.Builder url(String url) {
         ...
         * 重连策略,不传则使用默认重连策略
         */
        public RxCookieVolley.Builder retryPolicy(RetryPolicy retryPolicy) {
         ...
         * 编码,默认UTF-8
         */
        public RxCookieVolley.Builder encoding(String encoding) {
            this.httpConfig.mEncoding = encoding;
            return this;
        }

        private RxCookieVolley.Builder build() {
            if (request == null) {
                if (params == null) {
                    params = new HttpParams();
                } else {
                    if (httpConfig.mMethod == RxCookieVolley.Method.GET)
                ...
                if (contentType == RxCookieVolley.ContentType.JSON) {
                    request = new JsonRequest(httpConfig, params, callback);
                } else {
                    request = new HttpFormRequest(httpConfig, params, callback);
                }
    ...
    public static void get(String url, HttpCallback callback) {
        new RxCookieVolley.Builder().url(url).callback(callback).doTask();
    }

    public static void get(String url, HttpParams params, HttpCallback callback) {
        new RxCookieVolley.Builder().url(url).params(params).callback(callback).doTask();
    }

    public static void post(String url, HttpParams params, HttpCallback callback) {
        new RxCookieVolley.Builder().url(url).params(params).httpMethod(RxCookieVolley.Method.POST).callback(callback).doTask();
    }

    public static void post(String url, HttpParams params, ProgressListener listener,
                            HttpCallback callback) {
        new RxCookieVolley.Builder().url(url).params(params).progressListener(listener).httpMethod(RxCookieVolley.Method.POST)
                .callback(callback).doTask();
    }

    public static void jsonGet(String url, HttpParams params, HttpCallback callback) {
        new RxCookieVolley.Builder().url(url).params(params).contentType(RxCookieVolley.ContentType.JSON)
                .httpMethod(RxCookieVolley.Method.GET).callback(callback).doTask();
    }

    public static void jsonPost(String url, HttpParams params, HttpCallback callback) {
        new RxCookieVolley.Builder().url(url).params(params).contentType(RxCookieVolley.ContentType.JSON)
                .httpMethod(RxCookieVolley.Method.POST).callback(callback).doTask();
    }
    ...
    public static FileRequest download(String storeFilePath, String url, ProgressListener
        ...
        request.setTag(url);
        request.setOnProgressListener(progressListener);
        new RxCookieVolley.Builder().setRequest(request).doTask();
        return request;
    }
}
