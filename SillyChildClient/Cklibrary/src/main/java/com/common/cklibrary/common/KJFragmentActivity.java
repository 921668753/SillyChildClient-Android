...
public abstract class KJFragmentActivity extends FragmentActivity implements
    ...
    private static class KJActivityHandle extends Handler {
        private final SoftReference<KJFragmentActivity> mOuterInstance;

        KJActivityHandle(KJFragmentActivity outer) {
        ...
        public void handleMessage(android.os.Message msg) {
            KJFragmentActivity aty = mOuterInstance.get();
