...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    //构造方法
    public OptionsPickerView(OptionsPickerView.Builder builder) {
    ...
    public static class Builder {
        ...
        public OptionsPickerView.Builder setSubmitText(String Str_Cancel) {
            this.Str_Submit = Str_Cancel;
            return this;
        }

        public OptionsPickerView.Builder setCancelText(String Str_Cancel) {
            this.Str_Cancel = Str_Cancel;
            return this;
        }

        public OptionsPickerView.Builder setTitleText(String Str_Title) {
            this.Str_Title = Str_Title;
            return this;
        }

        public OptionsPickerView.Builder isDialog(boolean isDialog) {
            this.isDialog = isDialog;
            return this;
        }

        public OptionsPickerView.Builder setSubmitColor(int Color_Submit) {
            this.Color_Submit = Color_Submit;
            return this;
        }

        public OptionsPickerView.Builder setCancelColor(int Color_Cancel) {
         ...
         * @return
         */
        public OptionsPickerView.Builder setBackgroundId(int backgroundId) {
         ...
         * @return
         */
        public OptionsPickerView.Builder setDecorView(ViewGroup decorView) {
            this.decorView = decorView;
            return this;
        }


        public OptionsPickerView.Builder setLayoutRes(int res, CustomListener listener) {
            this.layoutRes = res;
            this.customListener = listener;
            return this;
        }

        public OptionsPickerView.Builder setBgColor(int Color_Background_Wheel) {
            this.Color_Background_Wheel = Color_Background_Wheel;
            return this;
        }

        public OptionsPickerView.Builder setTitleBgColor(int Color_Background_Title) {
            this.Color_Background_Title = Color_Background_Title;
            return this;
        }

        public OptionsPickerView.Builder setTitleColor(int Color_Title) {
            this.Color_Title = Color_Title;
            return this;
        }

        public OptionsPickerView.Builder setSubCalSize(int Size_Submit_Cancel) {
            this.Size_Submit_Cancel = Size_Submit_Cancel;
            return this;
        }

        public OptionsPickerView.Builder setTitleSize(int Size_Title) {
            this.Size_Title = Size_Title;
            return this;
        }

        public OptionsPickerView.Builder setContentTextSize(int Size_Content) {
            this.Size_Content = Size_Content;
            return this;
        }


        public OptionsPickerView.Builder setOutSideCancelable(boolean cancelable) {
         ...
         */
        @Deprecated
        public OptionsPickerView.Builder setLinkage(boolean linkage) {
            this.linkage = linkage;
            return this;
        }

        public OptionsPickerView.Builder setLabels(String label1, String label2, String label3) {
            this.label1 = label1;
            this.label2 = label2;
            this.label3 = label3;
            return this;
         ...
         */
        public OptionsPickerView.Builder setLineSpacingMultiplier(float lineSpacingMultiplier) {
         ...
         * @param dividerColor
         */
        public OptionsPickerView.Builder setDividerColor(int dividerColor) {
         ...
         * @param dividerType
         */
        public OptionsPickerView.Builder setDividerType(WheelView.DividerType dividerType) {
         ...
         */
        public OptionsPickerView.Builder setTextColorCenter(int textColorCenter) {
         ...
         * @param textColorOut
         */
        public OptionsPickerView.Builder setTextColorOut(int textColorOut) {
            this.textColorOut = textColorOut;
            return this;
        }

        public OptionsPickerView.Builder setTypeface(Typeface font) {
            this.font = font;
            return this;
        }

        public OptionsPickerView.Builder setCyclic(boolean cyclic1, boolean cyclic2, boolean cyclic3) {
        ...
        public OptionsPickerView.Builder setSelectOptions(int option1) {
            this.option1 = option1;
            return this;
        }

        public OptionsPickerView.Builder setSelectOptions(int option1, int option2) {
            this.option1 = option1;
            this.option2 = option2;
            return this;
        }

        public OptionsPickerView.Builder setSelectOptions(int option1, int option2, int option3) {
            this.option1 = option1;
            this.option2 = option2;
        ...
        public OptionsPickerView.Builder isCenterLabel(boolean isCenterLabel) {
...
//            rv_top_bar.setBackgroundColor(Color_Background_Title == 0 ? pickerview_bg_topbar : Color_Background_Title);
    ...
    public void cancelSelect() {
        if (optionsSelectListener != null) {
            optionsSelectListener.onOptionsCancel(clickView);
        }
    }
