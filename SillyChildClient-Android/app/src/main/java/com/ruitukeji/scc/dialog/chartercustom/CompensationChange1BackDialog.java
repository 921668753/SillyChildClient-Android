package com.ruitukeji.scc.dialog.chartercustom;
...
import com.ruitukeji.scc.entity.CompensationChangeBackBean;
...
public class CompensationChange1BackDialog extends Dialog implements CompensationChangeBackContract.View, View.OnClickListener {
    ...
    public CompensationChange1BackDialog(Context context, int type) {
