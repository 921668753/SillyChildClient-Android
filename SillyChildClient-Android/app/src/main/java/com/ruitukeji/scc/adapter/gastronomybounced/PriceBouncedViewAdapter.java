package com.ruitukeji.scc.adapter.gastronomybounced;
...
public class PriceBouncedViewAdapter extends BGAAdapterViewAdapter<ResultBean> {


    public PriceBouncedViewAdapter(Context context) {
