package com.ruitukeji.scc.mine.myorder.orderevaluation;
...
import com.ruitukeji.scc.mine.myorder.orderDetails.OrderDetailsContract;
...
public class PostEvaluationPresenter implements PostEvaluationContract.Presenter {
    private PostEvaluationContract.View mView;

    public PostEvaluationPresenter(PostEvaluationContract.View view) {
        mView = view;
