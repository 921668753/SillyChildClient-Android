...
import com.ruitukeji.scc.mine.mywallet.accountdetails.AccountDetailsActivity;
import com.ruitukeji.scc.mine.mywallet.coupons.CouponsActivity;
import com.ruitukeji.scc.mine.mywallet.recharge.RechargeActivity;
import com.ruitukeji.scc.mine.mywallet.withdraw.WithdrawActivity;
...
public class MyWalletActivity extends BaseActivity implements MyWalletContract.View{
    ...
    @BindView(id=R.id.ll_goshopping , click = true)
    private LinearLayout ll_goshopping;

    @BindView(id=R.id.ll_hangingout , click = true)
    private LinearLayout ll_hangingout;

    @BindView(id=R.id.ll_sleepin , click = true)
    private LinearLayout ll_sleepin;
    ...
    public void widgetClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.ll_withdraw:
                jumpintent=new Intent(this,WithdrawActivity.class);
            ...
            case R.id.ll_coupons:
                ...
                break;
            case R.id.ll_goshopping:
                Intent intent1 = new Intent(aty, MainActivity.class);
                intent1.putExtra("newChageIcon", 2);
                showActivity(this, intent1);
                finish();
                break;
            case R.id.ll_hangingout:
                showActivity(this, CharterCustomActivity.class);
                finish();
                break;
            case R.id.ll_sleepin:
                ViewInject.toast(getString(R.string.noDevelopment));
//                showActivity(this, HomestaySubscribeActivity.class);
//                finish();
                break;
        }
    }
