...
public class HomestayDetailsPresenter implements HomestayDetailsContract.Presenter {
    private HomestayDetailsContract.View mView;

    public HomestayDetailsPresenter(HomestayDetailsContract.View view) {
        mView = view;
