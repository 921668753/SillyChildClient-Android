package com.ruitukeji.scc.dialog.gastronomy;
...
public class PriceBouncedPresenter implements PriceBouncedContract.Presenter {
    private PriceBouncedContract.View mView;

    public PriceBouncedPresenter(PriceBouncedContract.View view) {
        mView = view;
        mView.setPresenter(this);
    }

    @Override
    public void getPriceBounced() {
