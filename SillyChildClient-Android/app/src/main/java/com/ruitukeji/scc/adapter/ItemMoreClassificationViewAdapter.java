...
import com.ruitukeji.scc.entity.AllDynamicsBean.ResultBean.ListBean;
...
public class ItemMoreClassificationViewAdapter extends BGAAdapterViewAdapter<ListBean> {

    public ItemMoreClassificationViewAdapter(Context context) {
