...
import com.ruitukeji.scc.entity.AllRoutesBean.ResultBean.ListBean;
...
public class AllLineViewAdapter extends BGAAdapterViewAdapter<ListBean> {

    public AllLineViewAdapter(Context context) {
