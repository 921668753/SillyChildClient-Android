package com.ruitukeji.scc.homepage.chartercustom.transfer;
...
public class AirportDropOffPresenter implements AirportDropOffContract.Presenter {
    ...
    @Override
    public void postAirportDropOff(String type, String flightNumber, String deliveredAirport, String placeDeparture, String selectModels, String workNumber, String bags, String bags1, String bags2, String bags3, String name, String contactWay, String fewAdults, String severalChildren, long departureTime, String remark, String con_car_seat_num,int pcpid) {
...
//        }
        ...
        if (StringUtils.isEmpty(deliveredAirport)) {
            mView.errorMsg(KJActivityStack.create().topActivity().getString(R.string.inputAirport1), 0);
            return;
        }
        if (StringUtils.isEmpty(placeDeparture)) {
            mView.errorMsg(KJActivityStack.create().topActivity().getString(R.string.pleaseSelectDeparturePoint), 0);
            return;
        }
//        if (selectModels <= 0) {
...
//行李
   ...
   //     httpParams.put("car_type_id", selectModels);
        ...
        httpParams.put("airport_name", deliveredAirport);
        httpParams.put("start_address", placeDeparture);
        ...
        RequestClient.postSendAirport(httpParams, new ResponseListener<String>() {
            @Override
