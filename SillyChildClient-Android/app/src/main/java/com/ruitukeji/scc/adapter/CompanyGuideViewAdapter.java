...
import com.ruitukeji.scc.entity.PackLineBean.ResultBean.DriverBeanX;
...
public class CompanyGuideViewAdapter extends BGAAdapterViewAdapter<DriverBeanX> {

    public CompanyGuideViewAdapter(Context context) {
        super(context, R.layout.item_localguide);
    }

    @Override
    public void fillData(BGAViewHolderHelper viewHolderHelper, int position, DriverBeanX listBean) {
