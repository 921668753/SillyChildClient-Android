...
public class ChatRowText extends ChatRow {
    ...
    protected void onInflatView() {
        inflater.inflate(message.direct() == Message.Direct.RECEIVE ? setLayout() : R.layout.hd_row_sent_message, this);
    }
    ...
    protected void handleTextMessage() {
        ...
        if (message.direct() == Message.Direct.SEND) {
            ...
            if (((EMTextMessageBody) message.getBody()).getMessage().startsWith("img/")) {
            //    Log.d("tag111", "11111");
            }
        }
    }
    ...
    private int setLayout() {
        EMTextMessageBody txtBody = (EMTextMessageBody) message.getBody();
        if (txtBody.getMessage().startsWith("img/")) {
         //      Log.d("tag1111", "11111");
            return R.layout.hd_row_received_message;
        }
        return R.layout.hd_row_received_message;
    }
